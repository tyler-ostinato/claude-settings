...
| `/simplify` | Review a file for clarity and token efficiency, then rewrite it in place |
| `/init-github` | Initialize a new git repo in a directory and push it to GitHub as a new remote repository |
